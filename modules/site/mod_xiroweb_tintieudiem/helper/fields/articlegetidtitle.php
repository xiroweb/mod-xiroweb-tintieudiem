 ...
 * @since  1.6
 */
class JFormFieldArticlegetidtitle extends JFormField
{
	/**
	 * The form field type.
	 *
	 ...
	 * @since  1.6
	 */
	protected $type = 'articlegetidtitle';
	...
	protected function getInput()
	{
		...
		JHtml::_('script', 'mod_xiroweb_tintieudiem/modal-fields2.js', array('version' => 'auto', 'relative' => true));
		...
		if ($allowSelect)
		{
			...
			if (!isset($scriptSelect[$this->id]))
			{
				...
				function jSelectArticle_" . $this->id . "(id, title, catid, object, url, language) {
					window.processModalSelect2('Article', '" . $this->id . "', id, title, catid, object, url, language);
				}
				");
		...
		$html .= '<input class="input-medium" id="' . $this->id . '_name" type="text" value="' . $title . '"  size="35" />';
		...
		if ($allowSelect)
		{
			$html .= JHtml::_(
				...
				array(
					...
					'bodyHeight'  => '70',
					'modalWidth'  => '80',
					'xiroweb_tintieudiemter'      => '<button type="button" class="btn" data-dismiss="modal">' . JText::_('JLIB_HTML_BEHAVIOR_CLOSE') . '</button>',
				)
			);
		}
		...
		if ($allowNew)
		{
			$html .= JHtml::_(
				...
				array(
					...
					'bodyHeight'  => '70',
					'modalWidth'  => '80',
					'xiroweb_tintieudiemter'      => '<button type="button" class="btn"'
