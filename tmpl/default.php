...
<div class="module<?php echo $moduleclass_sfx; ?> mod-tintieudiem-<?php echo $stylecss; ?>">
	<?php foreach ($list as  $key => $item) : ?>
			...
			<?php if ($rowcount === 1) : ?>
				...
				<div class="items-row <?php echo 'row-' . $row; ?> bs4row no-gutters bs4align-items-stretch bs4justify-content-md-around bs4justify-content-around">
			<?php endif; ?>

					<div class="bs4col-6 bs4col-md-<?php echo round((12 / $columns)); ?>">
